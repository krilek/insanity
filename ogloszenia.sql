...
--
-- Host: 127.0.0.1
-- Czas generowania: 17 Cze 2017, 18:49
...
(1, '$2y$10$sVst5wTVcImjiwv73KAy/OuDGk799MRMGX2MZSZwOi2J8SnfVEIra'),
(2, '$2y$10$vaeEA0pKOGdknmxE3TXU1.hgM6yGNBIREwOnqDVsmrYDRqdUPQBzG'),
(3, 'XDSAASDASD'),
(4, 'DASDASDASD');
...
(1, 'krilek', 'Karol', 'Gzik', 12, 'Częstochowa', 'M', 0),
(2, 'abcds', 'karo', 'kdasd', 1, 'Czewa', 'M', 0);
...
INSERT INTO `uzytkownicyrejestracja` (`ID`, `Login`, `Email`, `HasloHash`, `TokenHash`, `Imie`, `Nazwisko`, `Wojewodztwo`, `Miejscowosc`, `Plec`, `Typ`, `Data`) VALUES
(16, 'kjdsakjsahkjdha', 'ulcia6@interia.eu', '$2y$10$UBAWu/DHVpsR/tOpe8Vad.ctYOc5KeostAG32ONOJoI.Wv4/LQUAm', '2a50e9c2d6b89b95bcb416d6857f8b45', 'Urszula', 'Frukacz', 1, 'Częstochowa', 'K', 1, '2017-06-17 18:06:02');
