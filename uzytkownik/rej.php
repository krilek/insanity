...
function rejestracjaEmail($email, $imie, $id, $login, $token)
{
    $wiadomosc = "
    <h3>Witaj $imie!</h3>
    <p>W serwisie ____ zarejestrowano użytkownika o loginie $login.</p>\r\n
    <p>Aby potwierdzić rejestrację kliknij link poniżej\r\n
    ".UZYTKOWNIK_KAT."weryfikacja.php?id=$id&login=$login&token=$token</p>
    <p>Jeśli to nie ty, zignoruj tę wiadomość.
    Wiadomość wygenerowana automatycznie.</p>";
